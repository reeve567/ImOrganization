package dev.reeve.organization.game.zip

import de.innosystec.unrar.Archive
import de.innosystec.unrar.NativeStorage
import de.innosystec.unrar.rarfile.FileHeader
import dev.reeve.organization.game.IconInputType
...
object Archives {
	...
	object Icon {
		...
		suspend fun getExe(
			...
			val origin = extract(archive, gameDir, exeName, name,true)
	 ...
	 */
	fun extract(archive: File, gameDir: File, exeName: String, converted: String, onlyGetExe: Boolean): File {
		val folder = File(gameDir, converted)
